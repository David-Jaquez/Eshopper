...
<head>
    ...
    <meta name="Jaquez Almaguer" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 4200 690</a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="agregarproductos.php" target="_balnk"><i class="fa fa-plus"></i> Agregar</a></li>
